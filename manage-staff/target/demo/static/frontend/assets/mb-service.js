...
function AccountObj() {
    ...
    this.nodecr = "";//SangNT1 bo sung chan ghi co
...
function EvnObj(evnCustomerCode,
                evnCustomerName,
                evnCustomerAddress,
                evnCustomerEvnCode,
...
function requestMBService(requestUrl, data, loadMask, timeout, successCallback, failCallback) {
    ...
    setTimeout(function () {
        ...
        //setting request url
        try {
            xhr.open(gRequestMethod, requestUrl, true);
...
var gRespCodeNotShowAlert = ['1013', '1014', '2003', '2007', '2008', '2009', '1035', '1042'];//ngocdt3 xóa 35,42 //COM_TRUST_PAYEE,COM_PASSWORD_EXPIRE,23/01/2016 ngocdt3 bo sung 42
...
var gRespCodeSuccess = ['0', '1001', '1002', '1013', '1035', '1042']; //0: COM_SUCCESS, 1001: COM_OVER_LIMIT, 1002: COM_OVER_DATE_LIMIT, 1013: COM_TRUST_PAYEE,23/01/2016 ngocdt3 bo sung 42
