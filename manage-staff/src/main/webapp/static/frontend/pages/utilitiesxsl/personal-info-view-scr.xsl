    ...
    <div id='mainViewContent' class='main-layout-subview'>
      <div>
        <div class='panelContent'>
            ...
            value="COM_TXT_INPUT_PLACEHOLDER" id="id.fileUpload01" accept="image/png;image/jpg" style="width:320px; height:330px; display:none"/>
                                <input id="btnFile" type="button" class="form-control form-control-rightbutton" style="width:320px; height:330px; border: none;" onclick="document.getElementById('id.fileUpload01').click()"/>
