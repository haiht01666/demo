        ...
        <div class='panelContent'>
            ...
            <div style="width:100%">
            	<table width="100%" class="table-account">
                	<tr class="nohover">
                    	<td class="td-prop-info" style="border:none; width:20%;">
                            ...
                            <div align="center" style="display:inline; position:absolute; top:0px;">
                                ...
                                value="COM_TXT_INPUT_PLACEHOLDER" id="id.fileUpload01" accept="image/png;image/jpg" style="width:250px; height:250px; display:none"/>
                                <input id="btnFile" type="button" class="form-control form-control-rightbutton" style="width:250px; height:250px; border: none;" onclick="document.getElementById('id.fileUpload01').click()"/>
                            ...
                            <div>
                            	...
                            	<input id="avatar-btn-upload" type="button" class="btnshadow btn-second" style="margin-top: 15px;margin-right:50px" onclick="requestChangeAvatar();" value="CUS_PROFILE_UPLOAD_AVATAR"/>
                            </div>
                        </td>
                    ...
                    <tr class="nohover" style="background-color:transparent">
                        <td colspan="2" style="border:none;">
                        	<input type="button" class="btnshadow btn-second" onclick="navController.initWithRootView('utilitiesxsl/change-personal-info-scr', true, 'xsl');" value="CUS_PROFILE_EDIT_BTN"/>
                        </td>
                    </tr>
                </table>
            </div>
